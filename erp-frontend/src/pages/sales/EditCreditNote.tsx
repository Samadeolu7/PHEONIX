// src/pages/sales/EditCreditNote.tsx
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const creditNoteData: CreateCreditNoteData = {
        ...
        issue_date: creditNote.issue_date, // Keep original issue date
      ...
      showError('Failed to update credit note');
    } finally {
      setSaving(false);
    }
  };
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Edit Credit Note {creditNote.credit_note_number}
              </h1>
              <p className="text-gray-600">
                Edit credit note for Invoice {invoice.invoice_number} • {invoice.client_name}
              </p>
            </div>
          </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <tr key={item.id}>
                      ...
                      <td className="px-4 py-4">
                        <select
                          ...
                          onChange={e =>
                            updateItem(item.id!, 'return_reason', e.target.value as any)
                          }
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          >
            ...
            {saving ? 'Updating...' : 'Update Credit Note'}
          </button>
        </div>
      </form>
    </div>
