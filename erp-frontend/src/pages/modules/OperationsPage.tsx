      ...
      <div className="min-h-screen" style={{ background: BRAND.colors.offWhite }}>
        <div style={{ background: 'linear-gradient(135deg, #060e30 0%, #0a1857 60%, #162570 100%)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8">
            ...
            <h1 className="text-2xl font-bold text-white">Operations Management</h1>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-2xl border p-12 text-center" style={{ borderColor: BRAND.colors.border }}>
            ...
            <h2 className="text-lg font-bold mb-2" style={{ color: BRAND.colors.navyPrimary }}>No Operations Features Available</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8">
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white mb-1">Operations Management</h1>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-sm font-semibold truncate mb-1.5" style={{ color: BRAND.colors.navyPrimary }}>
                        {feature.title}
                      </h3>
