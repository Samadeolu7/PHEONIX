// src/pages/modules/FixedAssetModulePage.tsx
...
export const FixedAssetModulePage: React.FC = () => {
    ...
    <div className="min-h-screen" style={{ background: BRAND.colors.offWhite }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #060e30 0%, #0a1857 60%, #162570 100%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8">
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4">
              <div
                ...
                style={{ background: 'rgba(183,151,88,0.18)' }}
              >
                <Home className="w-6 h-6" style={{ color: BRAND.colors.gold }} />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-white mb-1">Fixed Assets</h1>
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>
                  Asset register, acquisitions, maintenance, depreciation, and fleet management
                </p>
              </div>
            </div>
            {totalFeatures > 0 && (
              <div className="text-right flex-shrink-0 hidden sm:block">
                <div className="text-3xl font-bold tabular-nums" style={{ color: BRAND.colors.gold }}>
                  {totalFeatures}
                </div>
                <div className="text-xs uppercase tracking-wider" style={{ color: 'rgba(255,255,255,0.45)' }}>
                  features
                </div>
              </div>
            )}
          ...
          <div
            className="h-px mt-6"
            style={{ background: 'linear-gradient(90deg, rgba(183,151,88,0.6), transparent)' }}
          />
        </div>
      </div>
        ...
        {totalFeatures === 0 && (
          ...
          >
            <div
              ...
              style={{ background: 'rgba(183,151,88,0.1)' }}
            >
              <Home className="w-7 h-7" style={{ color: BRAND.colors.gold }} />
            </div>
            <h2 className="text-lg font-bold mb-2" style={{ color: BRAND.colors.navyPrimary }}>
              No Fixed Asset Features Available
            </h2>
            <p className="text-sm" style={{ color: BRAND.colors.textSecondary }}>
              Your current role doesn&apos;t have permissions to access any fixed asset features.
            </p>
          </div>
        )}
          ...
          <div key={category} className="mb-10">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span
                ...
                style={{ background: 'rgba(10,24,87,0.07)', color: BRAND.colors.textSecondary }}
              >
                {features.length}
              </span>
            </div>
                ...
                return (
                  ...
                  >
                    <div
                      ...
                      style={{ background: 'rgba(10,24,87,0.07)' }}
                    >
                      ...
                      <div className="flex items-center gap-1.5 mb-1.5">
                        ...
                        {feature.isNew && (
                          <span
                            ...
                            style={{ background: 'rgba(183,151,88,0.15)', color: BRAND.colors.goldDark }}
                          >
                            NEW
                          </span>
                        )}
                        {feature.isEnhanced && (
                          <span
                            className="flex-shrink-0 text-xs font-bold px-1.5 py-0.5 rounded"
                            style={{ background: 'rgba(10,24,87,0.08)', color: BRAND.colors.navyPrimary }}
                          >
                            ENH
                          </span>
                        )}
