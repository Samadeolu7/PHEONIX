...
export const LoansModulePage: React.FC = () => {
  ...
  const groupedFeatures = getFeaturesGroupedByCategory('loans', hasPermission, selectedRole ?? undefined);
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(183,151,88,0.18)' }}>
                <CreditCard className="w-6 h-6" style={{ color: BRAND.colors.gold }} />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-white mb-1">Loans</h1>
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>Loan applications, verification, disbursements, repayments, and daily collection</p>
              </div>
            </div>
            {totalFeatures > 0 && (
        ...
        {totalFeatures === 0 && (
          <div className="bg-white rounded-2xl border p-12 text-center" style={{ borderColor: BRAND.colors.border }}>
            <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ background: 'rgba(183,151,88,0.1)' }}>
              <CreditCard className="w-7 h-7" style={{ color: BRAND.colors.gold }} />
            </div>
            <h2 className="text-lg font-bold mb-2" style={{ color: BRAND.colors.navyPrimary }}>No Loans Features Available</h2>
            <p className="text-sm" style={{ color: BRAND.colors.textSecondary }}>Your current role does not have permissions to access any Loans features.</p>
          </div>
        )}
