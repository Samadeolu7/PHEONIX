// src/pages/modules/ProcurementModulePage.tsx
...
export const ProcurementModulePage: React.FC = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8">
          ...
          <div className="flex items-start justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              >
                <ShoppingCart className="w-6 h-6" style={{ color: BRAND.colors.gold }} />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-white mb-1">Procurement</h1>
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>
                  Suppliers, purchase orders, requisitions, GRNs, and returns
                </p>
              </div>
            </div>
            {totalFeatures > 0 && (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {totalFeatures === 0 && (
          ...
          >
            ...
            >
              <ShoppingCart className="w-7 h-7" style={{ color: BRAND.colors.gold }} />
            </div>
            <h2 className="text-lg font-bold mb-2" style={{ color: BRAND.colors.navyPrimary }}>
              No Procurement Features Available
            </h2>
            <p className="text-sm" style={{ color: BRAND.colors.textSecondary }}>
              Your current role doesn&apos;t have permissions to access any procurement features.
            </p>
          </div>
        )}
