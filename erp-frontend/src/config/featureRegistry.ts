...
export const FEATURE_REGISTRY: FeatureCard[] = [
  ...
  },
  {
    ...
    title: '👥 Client Groups',
    description:
      'Create and manage savings/thrift groups; view member lists, group balances, and contribution status',
    path: '/clients/groups',
    icon: Users,
    requiredPermission: 'client-list',
    moduleId: 'client-services',
  ...
  // ----- Thrift / Daily Contribution Category -----
  {
    id: 'thrift-setup',
    title: '📅 Create Daily Contribution',
    description: 'Set up a new daily contribution (thrift) account for a client or group',
    path: '/savings/thrift/setup',
    icon: Calendar,
    requiredPermission: 'savings-create',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  {
    id: 'thrift-monthly',
    title: '📆 Activate Monthly Contribution',
    description: 'Activate a monthly savings contribution schedule for a client',
    path: '/savings/thrift/monthly',
    icon: Calendar,
    requiredPermission: 'savings-create',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  {
    id: 'thrift-smart-savings',
    title: '💡 Activate Smart Savings',
    description: 'Set up a smart savings plan with target amount and auto-contribution rules',
    path: '/savings/thrift/smart',
    icon: TrendingUp,
    requiredPermission: 'savings-create',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  },
  {
    ...
    title: '🏦 Receipt Thrift',
    description:
      'Record daily thrift contributions for individual clients — toggle/mark as collected',
    path: '/savings/thrift/collection',
    icon: ClipboardList,
    requiredPermission: 'savings-collection',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  {
    id: 'thrift-spreadsheet',
    title: '📊 Receipt Thrift Spreadsheet',
    description:
      'Bulk thrift collection using a spreadsheet-style grid — enter amounts for all group members at once',
    path: '/savings/thrift/spreadsheet',
    icon: BarChart3,
    requiredPermission: 'savings-collection',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  {
    id: 'thrift-multi-day',
    title: '📋 Receipt Multi-Day Thrift',
    description:
      'Record thrift contributions for multiple past days in a single entry — handles catch-up payments',
    path: '/savings/thrift/multi-day',
    icon: Calendar,
    requiredPermission: 'savings-collection',
    moduleId: 'client-services',
    category: 'Thrift',
  ...
  },
  {
    ...
    icon: DollarSign,
    requiredPermission: 'loans-disburse',
    moduleId: 'client-services',
    category: 'Loans',
    isNew: true,
  },
  ...
  },
  {
    ...
    icon: Plus,
    requiredPermission: 'treasury-create',
    moduleId: 'petty-cash',
    category: 'Funds',
  },
  {
  ...
  // ----- Thrift -----
  {
    ...
    requiredPermission: 'savings-create',
    moduleId: 'savings',
    category: 'Thrift / Daily Contribution',
    isNew: true,
  },
  {
    id: 'savings-mod-thrift-monthly',
    title: '📆 Activate Monthly Contribution',
    description: 'Activate a monthly savings contribution schedule for a client',
    path: '/savings/thrift/monthly',
    icon: Calendar,
  ...
  {
    id: 'savings-mod-thrift-receipt',
    title: '🏦 Receipt Thrift',
    description: 'Record daily thrift contributions for individual clients',
    path: '/savings/thrift/collection',
    icon: ClipboardList,
    requiredPermission: 'savings-collection',
    moduleId: 'savings',
  ...
  {
    id: 'savings-mod-thrift-spreadsheet',
    title: '📊 Receipt Thrift Spreadsheet',
    description:
      'Bulk thrift collection using a spreadsheet grid — enter amounts for all group members at once',
    path: '/savings/thrift/spreadsheet',
    icon: BarChart3,
    requiredPermission: 'savings-collection',
    moduleId: 'savings',
  ...
  {
    id: 'savings-mod-thrift-multiday',
    title: '📋 Receipt Multi-Day Thrift',
    description: 'Record thrift contributions for multiple past days in a single entry',
    path: '/savings/thrift/multi-day',
    icon: Calendar,
    requiredPermission: 'savings-collection',
    moduleId: 'savings',
  ...
  // ----- Savings Reports -----
  {
    id: 'savings-mod-thrift-report',
    title: '📈 Thrift Report',
    description: 'Thrift contribution summary by client, group, and date range',
    path: '/reports/thrift',
    icon: BarChart3,
    requiredPermission: 'savings-list',
    moduleId: 'savings',
