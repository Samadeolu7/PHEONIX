...
export const FEATURE_REGISTRY: FeatureCard[] = [
  ...
  {
    id: 'disbursement-master-roll',
    title: '📆 Disbursement Master Roll',
    description:
  ...
  },
  {
    ...
    description:
      'Group / officer / customer collection sheet — savings, registration, risk premium, loan form, ID card and loan repayment collections',
  ...
  },
  {
    ...
    description: 'Retired workflow — historical record of client-invoice-authorized material requests. Use Office Use Requests for new requests.',
  ...
  {
    id: 'loans-mod-disbursement-master-roll',
    title: '📆 Disbursement Master Roll',
    description:
      'Full disbursement roll for a day or month, with real collections, savings, new-client and defaulter summary tiles',
    path: '/reports/disbursement-master-roll',
  ...
  {
    id: 'loans-mod-daily-collection-report',
    title: '🧾 Daily Collection Report',
