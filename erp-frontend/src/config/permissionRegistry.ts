...
export const PERMISSION_REGISTRY: PermModule[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { code: 'loan-reports', title: 'Loan Reports', description: 'Portfolio, debtors, defaulters, PAR, disbursement master roll and daily collection reports', paths: ['/reports/daily-summary', '/reports/disbursement-master-roll', '/reports/daily-collection-report', '/reports/daily-transactions', '/reports/loans/debtors', '/reports/loans/defaulters', '/reports/loans/par', '/reports/officer-portfolio', '/reports/portfolio-performance', '/reports/summary'] },
    ],
  },
  {
    code: 'savings',
